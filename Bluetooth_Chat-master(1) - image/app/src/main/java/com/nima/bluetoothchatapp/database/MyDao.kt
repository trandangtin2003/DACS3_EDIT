...
interface MyDao {
    ...
    fun cap_nhat_trang_thai_tn_cua_toi(status : String,uId :String,message  :String)
    ...
    fun getConnectedDevices() : LiveData<List<ConnectedDevices>>
        //onConflict = OnConflictStrategy.REPLACE thay thế dữ liệu cũ bằng dữ liệu mới khi có trùng lặp khóa chính
    @Insert(onConflict = OnConflictStrategy.REPLACE)
